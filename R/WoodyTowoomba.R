...
#'   \item{EC, pH, B, C, Na, Mg, P, S, N, K, Ca, Mn, Cu, Zn, N_NO3, N_NH4}{Soil nutrient and element concentration of the pedoderm (0-2 cm) in mg/kg, except for pH (unitless), EC (uS/cm) and C (%).}
#' }
#' 
